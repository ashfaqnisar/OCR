      ...
      <CardBody>
        <div className="card__title">
          <h5 className="bold-text">
            {t('ui_elements.buttons.buttons_icons_and_expand')}
          </h5>
        </div>
        <h5 className="bold-text">Icon buttons</h5>
        <div className="card__title">
          <h5 className="subhead">
            Use default buttons with class{' '}
        ...
        <ButtonToolbar>
          ...
          <Button className="icon" color="success">
            <p>
              <ThumbUpOutlineIcon /> Success
            </p>
          </Button>
          <Button className="icon" color="warning">
            <p>
              <CommentAlertOutlineIcon /> Danger
            </p>
          </Button>
          <Button className="icon" color="danger">
            <p>
              <CloseCircleOutlineIcon /> Warning
            </p>
          </Button>
        </ButtonToolbar>
