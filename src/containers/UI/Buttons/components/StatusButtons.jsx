      ...
      <CardBody>
        <div className="card__title">
          <h5 className="bold-text">
            {t('ui_elements.buttons.status_buttons')}
          </h5>
          <h5 className="subhead">
            Use default buttons with property{' '}
        ...
        <div className="card__title">
          <h5 className="subhead">
            Use the modifier <span className="red-text">sm</span>
          </h5>
        </div>
        <ButtonToolbar>
        ...
        <div className="card__title">
          <h5 className="subhead">
            Use the modifier <span className="red-text">lg</span>
          </h5>
        </div>
        <ButtonToolbar>
