          ...
          <CardBody>
            <div className="card__title">
              <h5 className="bold-text">
                {t('ui_elements.notifications.image_notifications')}
              </h5>
              <h5 className="subhead">
                Use ImageNotification with necessary value of properties
                <span className="red-text"> position</span> and{' '}
                <span className="red-text">img</span>
              </h5>
            </div>
            <ButtonToolbar>
              <Button outline onClick={() => this.show('left-up')}>
                Left Up
              </Button>
              <Button outline onClick={() => this.show('right-up')}>
                Right Up
              </Button>
            </ButtonToolbar>
          </CardBody>
