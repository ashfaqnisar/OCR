          ...
          <CardBody>
            <div className="card__title">
              <h5 className="bold-text">
                {t('ui_elements.tabs.justify_tabs_bordered_bottom')}
              </h5>
              <h5 className="subhead">
                Use default tabs with classes
                <span className="red-text">
                  {' '}
                  tabs--justify tabs--bordered-bottom
                </span>
              </h5>
            </div>
                ...
                <TabContent activeTab={activeTab}>
                  <TabPane tabId="1">
                    <p>
                      ...
                      sir her. Although desirous not recurred disposed off shy
                      you numerous securing.
                    </p>
                  </TabPane>
                  <TabPane tabId="2">
                    <p>
